...
# {{site.data.keyword.cloudant_short_notm}} 데이터베이스에 액세스하기 위한 간단한 {{site.data.keyword.Bluemix_notm}} 애플리케이션 작성: 애플리케이션 환경
...
7.  잠시 후 새 애플리케이션 환경에 대한 '`Getting Started`' 창이 표시됩니다.
    ...
    {{site.data.keyword.Bluemix_notm}} 계정 대시보드로 돌아가려면 '`Dashboard`' 링크를 클릭하십시오.<br/>
...
## Cloud Foundry 및 {{site.data.keyword.Bluemix_notm}} 명령 툴킷
