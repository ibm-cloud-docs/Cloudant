...
# {{site.data.keyword.cloudant_short_notm}} 데이터베이스에 액세스하기 위한 간단한 {{site.data.keyword.Bluemix_notm}} 애플리케이션 작성: 애플리케이션 업로드
...
## {{site.data.keyword.Bluemix_notm}}에 연결
...
다음 단계는 {{site.data.keyword.Bluemix_notm}} 애플리케이션 환경에 로그인하는 것입니다.
...
다음 예와 유사한 명령을 사용하여 {{site.data.keyword.Bluemix_notm}} 애플리케이션 환경에 로그인하십시오.
...
이제 {{site.data.keyword.cloudant_short_notm}} Foundry 툴킷은 {{site.data.keyword.Bluemix_notm}} 환경에 연결하는 방법을 알고 있습니다. 

다음 단계는 애플리케이션 자체를 업로드하는 것입니다.
{{site.data.keyword.Bluemix_notm}} 애플리케이션의 세부사항은 [Manifest 파일](create_bmxapp_appenv.html#manifest)에서 제공됩니다.
