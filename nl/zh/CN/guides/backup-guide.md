...
本手册构成了 [{{site.data.keyword.cloudantfull}} 灾难恢复指南](disaster-recovery-and-backup.html)的一部分。如果您是第一次接触本主题，并且希望了解备份在哪些方面可与 {{site.data.keyword.cloudantfull}} 提供的其他功能配合使用，以支持灾难恢复 (DR) 和高可用性 (HA) 需求，那么应该首先阅读此处的内容。
