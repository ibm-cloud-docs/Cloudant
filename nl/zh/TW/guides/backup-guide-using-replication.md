...
_使用 HTTP 取得檢查點 ID 來協助尋找 `recorded_seq` 值：_
...
_使用指令行取得檢查點 ID 來協助尋找 `recorded_seq` 值：_
...
_使用 HTTP 從原始資料庫中取得 `recorded_seq`：_
...
_使用指令行從原始資料庫中取得 `recorded_seq`：_
