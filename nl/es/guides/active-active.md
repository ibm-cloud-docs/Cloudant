...
> **Nota**: Para un despliegue de tipo activo-activo, debe haber una estrategia para gestionar conflictos.
  Por lo tanto, asegúrese de comprender el funcionamiento de la [réplica](../api/replication.html) y de los [conflictos](mvcc.html#distributed-databases-and-conflicts) antes de tener en cuenta esta arquitectura.
...
> **Nota**: Anote la contraseña.
  No se puede recuperar la contraseña posteriormente.
...
* Tenga en cuenta la supervisión de las [réplicas](../api/advanced_replication.html) entre las bases de datos.
...
> **Nota:** Si una base de datos se modifica constantemente, es poco probable que el estado de la réplica sea 0.
  Debe decidir el umbral de estado aceptable; de lo contrario esto representaría un estado de error.
