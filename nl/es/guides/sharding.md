...
>	**Nota:** Si se reduce el valor de _R_, aumenta la probabilidad de que la respuesta devuelta no se base en los datos más actualizados debido al modelo de [coherencia final](cap_theorem.html) que utiliza {{site.data.keyword.cloudant_short_notm}}.
