...
Vale la pena empezar por aquí si es nuevo en la materia y desea comprender cómo se combina la copia de seguridad con las otras características que ofrece {{site.data.keyword.cloudantfull}} para dar soporte a los requisitos de recuperación en caso de error
