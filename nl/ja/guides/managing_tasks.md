...
[`_active_tasks` エンドポイント](../api/active_tasks.html) は、実行中のすべてのタスクに関する情報を提供します。
...
使用可能オプションの完全ガイドについては、[API リファレンス](../api/index.html)を参照してください。
...
[API リファレンス](../api/index.html)に、これらのオプションに関する詳細情報が記載されています。
