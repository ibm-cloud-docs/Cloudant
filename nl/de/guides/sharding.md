...
# Wie werden Daten in Cloudant gespeichert?

## Konzepte

Jede Datenbank in Cloudant setzt sich aus einem oder mehreren unterschiedlichen _Shards_ zusammen.
Die Anzahl dieser Shards wird mit _Q_ bezeichnet.
...
Es wäre sehr ungewöhnlich für ein Cloudant-System, eine andere Anzahl von Replikaten zu verwenden. 
...
1.	Jedes Dokument in der Datenbank wird in einem einzelnen Shard gespeichert.
	...
	Der Grund dafür ist, dass der Koordinator nur an die Knoten Anforderungen sendet, die das Dokument enthalten. Wenn also
...
Cloudant optimiert die Standardwerte für Cluster im Laufe der Zeit, wenn sich die Verwendungsmuster ändern. 
...
Tests mit repräsentativen Daten und Anforderungsmustern sind wichtig, um realistische _Q_-Werte zu schätzen. Aber stellen Sie sich darauf ein, dass die Praxis Sie eines Besseren belehren wird. 
...
*	Und bei noch größeren Datenbanken sollten Sie Ihre Daten auf mehrere Datenbanken verteilen.
	Wenden Sie sich in diesem Fall an den [Cloudant-Support ![Symbol für externen Link](../images/launch-glyph.svg "Symbol für externen Link")](mailto:support@cloudant.com){:new_window}. 
...
>	**Hinweis:** Das Festlegen von _Q_ für Datenbanken ist für Cloudant-Datenbanken unter Bluemix nicht aktiviert.
...
Weitere Unterstützung erhalten Sie vom [Cloudant-Support ![Symbol für externen Link](../images/launch-glyph.svg "Symbol für externen Link")](mailto:support@cloudant.com){:new_window}. 
...
>	**Hinweis:** Wenn der Wert _R_ verkleinert wird, steigt die Wahrscheinlichkeit, dass die zurückgegebene Antwort
	aufgrund des Modells der [sukzessiven Konsistenz](cap_theorem.html) von Cloudant nicht auf den aktuellen Daten basiert.
