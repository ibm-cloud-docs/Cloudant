...
# Cloudant-Sicherung und -Wiederherstellung
...
## Cloudant-Daten wiederherstellen
...
* Eine Bibliothek, die von Node.js verwendet werden kann.
  Die Bibliothek lässt zu, dass kompliziertere Sicherungsprozesse erstellt und implementiert werden können,
  z. B. das dynamische Bestimmen, welche Datenbanken gesichert werden müssen. 
