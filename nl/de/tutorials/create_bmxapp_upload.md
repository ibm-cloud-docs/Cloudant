...
# Einfache Bluemix-Anwendung für den Zugriff auf eine Cloudant-Datenbank erstellen: Anwendung hochladen
...
Cloud Foundry muss die URL kennen, die für API-Aufrufe verwendet werden soll,
z. B. wenn Sie eine Anwendung hochladen.
...
Das Cloudant Foundry-Toolkit weiß jetzt, wie es eine Verbindung zur {{site.data.keyword.Bluemix_notm}}-Umgebung herstellt. 
...
Die Anwendung wird automatisch gestartet. Beim Start wird geprüft,
...
Die Datenbank enthält ein einzelnes Dokument, das von der Anwendung erstellt wurde. Klicken Sie auf den Datenbanknamen
...
Der nächste Schritt im Lernprogramm besteht darin, [die Anwendung auszuführen und zu warten](create_bmxapp_maintain.html),
z. B. wenn Sie die Anwendung starten, stoppen und debuggen. 
