...
When you exceed the number of allowed events, {{site.data.keyword.cloudant_short_notm}} generates a [*`429` Too Many Requests*](/docs/apis/cloudant/cloudant-gen1#list-of-http-codes){: external}
