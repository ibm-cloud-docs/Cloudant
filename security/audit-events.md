...
Events are available in the Dallas, Washington DC, Frankfurt, Tokyo, Sydney, and London locations. For more information, see [{{site.data.keyword.cloud_notm}} services locations](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-cloud_services_locations).
