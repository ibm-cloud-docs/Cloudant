...
See the [API Reference](/docs/services/Cloudant?topic=cloudant-api-reference-overview#api-reference-overview) for more information about meteor-couchdb APIs. 
