...
you might get the following error, [*503: Service unavailable*](/apidocs/cloudant#list-of-http-codes){: external}. You can see the types of authentication that are available in the following list: 
