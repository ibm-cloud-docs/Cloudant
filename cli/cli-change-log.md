...
- Upgraded to {{site.data.keyword.cloudant_short_notm}} Go SDK version: `0.10.17`.
...
Version `0.2.15` of CLI was released on 26 Jun 2026.

- Upgraded to {{site.data.keyword.cloudant_short_notm}} Go SDK version: `0.10.15`.
- Improved help text.
- Updated dependencies.
- Updated documentation.
...
Version `0.2.14` of CLI was released on 29 April 2026.

- Upgraded to {{site.data.keyword.cloudant_short_notm}} Go SDK version: `0.10.13`.
- Updated dependencies.
- Fixed print `OK` only for successful responses.
...
Version `0.2.13` of CLI was released on 23 March 2026.

- Upgraded to {{site.data.keyword.cloudant_short_notm}} Go SDK version: `0.10.12`.
- Updated dependencies.
- Output formatting fixes for some sub options.
...
Version `0.2.12` of CLI was released on 13 February 2026.

- Upgraded to {{site.data.keyword.cloudant_short_notm}} Go SDK version: `0.10.11`.
- Improved table printing and help text.
- Updated dependencies.
- Updated documentation.
...
Version `0.2.11` of CLI was released on 09 December 2025.

- Upgraded to {{site.data.keyword.cloudant_short_notm}} Go SDK version: `0.10.9`.
- Updated dependencies.
- Updated documentation.
