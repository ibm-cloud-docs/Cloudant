...
- Add the `X-Frame-Options` header settings to prevent clickjacking. Learn more about <a href="deprecations.html#xframeoptions" target="_blank">X-Frame-Options</a>. 
