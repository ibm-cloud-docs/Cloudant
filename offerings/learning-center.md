...
The ISO-8601 string format for representing a time time consists of a y-m-dTh:m:s.msTIMEZONE year, month, day, a 'T' character, hour, minute, second, millisecond and timezone.
