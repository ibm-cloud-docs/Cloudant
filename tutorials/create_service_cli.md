...
See the [Plans](/docs/Cloudant?topic=Cloudant-ibm-cloud-public#plans-and-provisioning) section of the documentation for details on using the {{site.data.keyword.cloudant_short_notm}} Lite or Standard plan.
{: pre}
