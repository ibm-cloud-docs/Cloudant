...
`202 - Accepted`                        | Request has been accepted, but the [quorum](/docs/services/Cloudant?topic=cloudant-documents#quorum-writing-and-reading-data) for the operation was not met.
