...
{{site.data.keyword.cloudantfull}}'s warehousing integration is a streamlined process which will
...
is imported into the connected Db2 Warehouse database. The number of fields in a schema is limited to 
1012 by Db2 Warehouse on Cloud/{{site.data.keyword.DB2OnCloud_short}}. 
