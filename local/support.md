...
{{site.data.keyword.IBM}} Cloudant&reg; Data Layer Local Edition ({{site.data.keyword.cloudant_local_notm}}) support provides assistance with the installation, set up, and proper usage of {{site.data.keyword.cloudant_local_notm}}. If a performance issue or inconsistency occurs, support helps troubleshoot it. If an outage occurs, support can help diagnose the issue, but the responsibility for resolving the issue rests with the customer team since we do not have access to customer systems.
{: shortdesc}
...
3. The email must contain the following details to help us diagnose your problem:
    ...
    - {{site.data.keyword.cloudant_local_notm}} verison you use.
    - Linux distribution and version you use to run {{site.data.keyword.cloudant_local_notm}}.
